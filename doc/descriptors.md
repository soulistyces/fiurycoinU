# Support for Output Descriptors in Fiurycoin Core

Since Fiurycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Fiurycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Fiurycoin Core wallets, a convenience function `combo` is
