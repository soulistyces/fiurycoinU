...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fiurycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fiurycoin-tx [options] <hex-tx> [commands]  Update hex-encoded fiurycoin transaction\n" +
            "or:     fiurycoin-tx [options] -create [commands]   Create hex-encoded fiurycoin transaction\n" +
            "\n";
