...
"""Verify that starting fiurycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fiurycoin with -h for help text")
        ...
        self.log.info("Start fiurycoin with -version for version information")
        ...
        self.log.info("Start fiurycoind with -fakearg to make sure it does not start")
